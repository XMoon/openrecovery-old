...
static RootInfo g_roots[] = {
    ...
    { "SDDATA:", "/dev/block/mmcblk0p2", NULL, NULL, "/sddata", "ext2" },
    { "SYSTEM:", g_mtd_device, NULL, "system", "/system", "yaffs2" },
    { "MBM:", g_mtd_device, NULL, "mbm", NULL, g_raw },
    { "BPLOADER:", g_mtd_device, NULL, "bploader", NULL, g_raw },
    { "CDT:", g_mtd_device, NULL, "cdt", NULL, g_raw },
    { "LBL:", g_mtd_device, NULL, "lbl", NULL, g_raw },
    { "BPSW:", g_mtd_device, NULL, "bpsw", NULL, g_raw },
    { "TMP:", NULL, NULL, NULL, "/tmp", NULL },
    
    #ifdef HAVE_CUST
    	{ "CUST:", g_mtd_device, NULL, "cust", "/cust", "yaffs2" },
    #endif    
};
...
static int
device_node_exists(const char *root_path)
{
	const RootInfo *info = get_root_info_for_path(root_path);
  ...
  intStat = stat(info->device, &stFileInfo); 
  if(intStat == 0)
		return 1;
		
	intStat = stat(info->device2, &stFileInfo); 
  if(intStat == 0)
		return 1;

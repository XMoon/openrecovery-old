...
LOCAL_STATIC_LIBRARIES += libenvfix
LOCAL_STATIC_LIBRARIES += libstdc++ libc

include $(BUILD_EXECUTABLE)

#OPEN RECOVERY FOR THE MILESTONE - LITE
#=========================================================================================================================
include $(CLEAR_VARS)
...
LOCAL_MODULE := open_recovery_lite_SHOLS
LOCAL_MODULE_STEM := open_rcvr_lite.SHOLS
LOCAL_MODULE_PATH := $(TARGET_RECOVERY_OUT)
LOCAL_UNSTRIPPED_PATH := $(TARGET_OUT_UNSTRIPPED)/recovery/
...
RECOVERY_API_VERSION := 2
LOCAL_CFLAGS += -DRECOVERY_API_VERSION=$(RECOVERY_API_VERSION) -DOPEN_RCVR_SHOLS -DOPEN_RCVR_VERSION_LITE
...
#OPEN RECOVERY FOR THE MILESTONE XT720
#=========================================================================================================================
include $(CLEAR_VARS)
...
LOCAL_MODULE := open_recovery_STR
LOCAL_MODULE_STEM := open_rcvr.STR
LOCAL_MODULE_PATH := $(TARGET_RECOVERY_OUT)
LOCAL_UNSTRIPPED_PATH := $(TARGET_OUT_UNSTRIPPED)/recovery/
...
RECOVERY_API_VERSION := 2
LOCAL_CFLAGS += -DRECOVERY_API_VERSION=$(RECOVERY_API_VERSION) -DOPEN_RCVR_STR
...
#OPEN RECOVERY FOR THE MILESTONE XT720 - LITE
#=========================================================================================================================
include $(CLEAR_VARS)
...
LOCAL_MODULE := open_recovery_lite_STR
LOCAL_MODULE_STEM := open_rcvr_lite.STR
LOCAL_MODULE_PATH := $(TARGET_RECOVERY_OUT)
LOCAL_UNSTRIPPED_PATH := $(TARGET_OUT_UNSTRIPPED)/recovery/
...
RECOVERY_API_VERSION := 2
LOCAL_CFLAGS += -DRECOVERY_API_VERSION=$(RECOVERY_API_VERSION) -DOPEN_RCVR_STR -DOPEN_RCVR_VERSION_LITE
